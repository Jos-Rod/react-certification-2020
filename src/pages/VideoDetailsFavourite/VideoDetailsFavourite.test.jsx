...
test('Title and description of video is rendered correctly', () => {
  ...
  const descriptionLabel = screen.getByText(
    /Engineering a better tomorrow. Wizeline is a global software development company that helps its clients solve their biggest challenges with design and .../i
  );
